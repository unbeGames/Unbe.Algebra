...
namespace Unbe.Algebra.Noise {
   ...
   * x = r - x; y = r - y; z = r - z;
  */
  public readonly struct OpenSimplex2S : INoise3D {
      ...
      var value = (a0 * a0) * (a0 * a0) * GradCoord(seed, ijk.x + (nMask.x & PrimeX), ijk.y + (nMask.y & PrimeY), ijk.z + (nMask.z & PrimeZ), p0.x, p0.y, p0.z);
